...
class ControllerModuleBossSlideshow extends Controller {
	...
	public function install() 
	{
		...
		$boss_slideshow = array('image_sliders' => array ( 
			0 => array ('description' => $array_description0,'link' => '#', 'image' => 'data/'.$this->config->get('config_template').'/slide1.jpg'),
			1 => array ('description' => $array_description1,'link' => '#', 'image' => 'data/'.$this->config->get('config_template').'/slide2.jpg'),
			2 => array ('description' => $array_description2,'link' => '#', 'image' => 'data/'.$this->config->get('config_template').'/slide3.jpg'),
		),'boss_slideshow_module' => array ( 
			0 => array ('image_width' => 680, 'image_height' => 285, 'layout_id' => $this->getIdLayout("home"), 'position' => 'header_bottom', 'status' => 1, 'sort_order' => 1))
		);
