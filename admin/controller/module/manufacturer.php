...
class ControllerModuleManufacturer extends Controller {
	...
	public function install() 
	{
		...
		$manufacturer = array('manufacturer_module' => array ( 
			0 => array ('layout_id' => $this->getIdLayout("category"), 'position' => 'column_left',  'status' => 1, 'sort_order' => 2),
			1 => array ('layout_id' => $this->getIdLayout("manufacturer"), 'position' => 'column_left',  'status' => 1, 'sort_order' => 2),
			2 => array ('layout_id' => $this->getIdLayout("product"), 'position' => 'column_left',  'status' => 1, 'sort_order' => 2)
		));

		$this->model_setting_setting->editSetting('manufacturer', $manufacturer);		
	}
