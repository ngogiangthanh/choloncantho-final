...
class ModelAccountOrder extends Model {
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			...
			return array(
				...
				'tinh_trang'			  => $order_query->row['tinh_trang']
			);
		} else {
			return false;	
		}
	...
	public function updateTT($order_id, $tt_order){
		$query = $this->db->query("update `res_order` set `tinh_trang`='".$tt_order."' where `order_id`=".$order_id);
		return $tt_order;
	}
}
?>