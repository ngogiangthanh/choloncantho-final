...
<div id="content" class="nineteen columns omega"><?php echo $content_top; ?>
  ...
  <form class="register-affiliate" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="buttons">
      <div class="left">
        ...
        <input type="submit" value="<?php echo $button_continue; ?>" class="button" /></span>
      </div>
    </div>
    <?php } else { ?>
    <div class="buttons">
      <div class="left">
         <span class="boss_button"><input type="submit" value="<?php echo $button_continue; ?>" class="button" /></span>
      </div>
    </div>
    <?php } ?>
  </form>
