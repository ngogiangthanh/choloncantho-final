...
<div style="clear: both; padding-top: 13px; line-height:22px">
...
<div class="buttons">
  <div class="left">
    ...
    <span class="boss_button"><input type="button" value="<?php echo $button_continue; ?>" id="button-register" class="button" /></span>
  </div>
</div>
<?php } else { ?>
<div class="buttons">
