...
class ControllerModuleBossHomecategoryColumn extends Controller {
	...
	{
		$this->load->model('setting/setting');
		$boss_homecategory_column = array('boss_homecategory_column_module' => array ( 
			0 => array ('width' => 80, 'height' => 80, 'limit' => 9, 'category_id' =>  18 ,'layout_id' => $this->getIdLayout("home"), 'position' => 'content_top', 'status' => 1, 'sort_order' => 7),
			1 => array ('width' => 80, 'height' => 80, 'limit' => 9, 'category_id' =>  34 ,'layout_id' => $this->getIdLayout("home"), 'position' => 'content_top', 'status' => 1, 'sort_order' => 10),
			2 => array ('width' => 80, 'height' => 80, 'limit' => 9, 'category_id' =>  20 ,'layout_id' => $this->getIdLayout("home"), 'position' => 'content_top', 'status' => 1, 'sort_order' => 14)
			)
		);
		
		$this->model_setting_setting->editSetting('boss_homecategory_column', $boss_homecategory_column);		
	}	
}
?>