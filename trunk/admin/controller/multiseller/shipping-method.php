...
class ControllerMultisellerShippingMethod extends ControllerMultisellerBase {
	...
	public function index() {
		...
		list($this->template, $this->children) = $this->MsLoader->MsHelper->admLoadTemplate('shipping-method'); 
	...
	public function insert() {
		...
		list($this->template, $this->children) = $this->MsLoader->MsHelper->admLoadTemplate('shipping-method-form'); 
		$this->response->setOutput($this->render());
	}
	...
	public function delete() { 
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			...
			$this->redirect($this->url->link('multiseller/shipping-method', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
