	  	...
	  	<div class="content">
			<form id="settings" method="post" enctype="multipart/form-data">
			 	<div id="tabs" class="htabs">
					...
					<a href="#tab-shipping"><?php echo $ms_tab_shipping; ?></a>
				...
				<div id="tab-shipping">
					<table class="form">
						...
						<tr>
							<td>
								<span><?php echo $ms_config_enable_product_shipping_cost_estimation; ?></span>
								<span class="help"><?php echo $ms_config_enable_product_shipping_cost_estimation_note; ?></span>
							</td>
							<td>
								<input type="radio" name="msconf_product_shipping_cost_estimation" value="1" <?php if($msconf_product_shipping_cost_estimation == 1) { ?> checked="checked" <?php } ?>  />
								<?php echo $text_yes; ?>
								<input type="radio" name="msconf_product_shipping_cost_estimation" value="0" <?php if($msconf_product_shipping_cost_estimation == 0) { ?> checked="checked" <?php } ?>  />
								<?php echo $text_no; ?>
							</td>
						</tr>
						...
						<tr>
							<td>
								<span><?php echo $ms_config_enable_minicart_shipping_estimate; ?></span>
								<span class="help"><?php echo $ms_config_enable_minicart_shipping_estimate_note; ?></span>
							</td>
							<td>
								<input type="radio" name="msconf_enable_minicart_shipping_estimate" value="1" <?php if($msconf_enable_minicart_shipping_estimate == 1) { ?> checked="checked" <?php } ?>  />
								<?php echo $text_yes; ?>
								<input type="radio" name="msconf_enable_minicart_shipping_estimate" value="0" <?php if($msconf_enable_minicart_shipping_estimate == 0) { ?> checked="checked" <?php } ?>  />
								<?php echo $text_no; ?>
							</td>
						</tr>
					</table>
				...
				<table class="form">
					...
					<tr>
						...
						<td>
							<input type="radio" name="msconf_download_limit_applies" value="1" <?php if($msconf_download_limit_applies == 1) { ?> checked="checked" <?php } ?>  />
							<?php echo $ms_config_download_limit_applies_digital; ?>
							<input type="radio" name="msconf_download_limit_applies" value="0" <?php if($msconf_download_limit_applies == 0) { ?> checked="checked" <?php } ?>  />
