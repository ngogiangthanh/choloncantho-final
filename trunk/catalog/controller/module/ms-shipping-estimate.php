...
class ControllerModuleMsShippingEstimate extends Controller {
	...
	public function getRates() {
		if (!$this->config->get('msconf_product_shipping_cost_estimation')) return;
		...
		list($this->template, $this->children) = $this->MsLoader->MsHelper->loadTemplate('shipping-estimate-table', array());
