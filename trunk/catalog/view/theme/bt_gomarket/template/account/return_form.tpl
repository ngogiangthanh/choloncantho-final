	 ...
	 <h2><?php echo $text_product; ?></h2>
      <div class="content">
        <div class="return-product">
          <div class="return-name six columns alpha">
          ...
          <div class="return-model six columns">
          ...
          <div class="return-quantity six columns omega">
			<b><?php echo $entry_quantity; ?></b><br />
            <input type="text" name="quantity" value="<?php echo $quantity; ?>" />
          </div>
        </div>
        <div class="return-detail">
          <div class="return-reason six columns alpha">
          ...
          <div class="return-opened six columns">
          ...
          <div class="return-captcha six columns omega">
