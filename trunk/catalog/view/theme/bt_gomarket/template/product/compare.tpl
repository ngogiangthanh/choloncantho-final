  ...
  <table class="compare-info">
    ...
    <tbody>
      ...
      <tr>
        ...
        <?php foreach ($products as $product) { ?>
        <td><img src="catalog/view/theme/bt_gomarket/image/stars-<?php echo $products[$product['product_id']]['rating']; ?>.png" alt="<?php echo $products[$product['product_id']]['reviews']; ?>" /></td>
        <?php } ?>
      </tr>
      <?php } ?>
	  <tr>
    ...
    <tr>
      ...
      <?php foreach ($products as $product) { ?>
      <td class="remove">
	   <span class="boss_button"><input type="button" value="<?php echo $button_cart; ?>" onclick="boss_addToCart('<?php echo $product['product_id']; ?>');" class="button" /></span><br />
	  <a href="<?php echo $product['remove']; ?>"><img src="catalog/view/theme/bt_gomarket/image/remove.png" alt="<?php echo $button_remove; ?>" title="<?php echo $button_remove; ?>" /><?php echo $button_remove; ?></a>
      <?php } ?>
    </tr>
	 </tfoot>
  </table>
