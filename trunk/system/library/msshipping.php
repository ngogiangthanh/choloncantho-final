...
class MsShipping extends Model {
	...
	public function createSellerShippingMethod($seller_id, $data) {
		$data['cost_per_unit'] = $this->currency->convert($data['cost_per_unit'], $this->currency->getCode(), $this->config->get('config_currency'));
	...
	public function createProductShippingMethod($product_id, $data) {
		$data['cost'] = $this->currency->convert($data['cost'], $this->currency->getCode(), $this->config->get('config_currency'));
